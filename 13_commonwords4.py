# You will often want to sort these values. While you can't
# technically sort a dictionary while keeping a dictionary, 
# you can save a sorted representation:
...
# Reverse sort the keys. Note that we can break some things
# across lines
revSortedWords = sorted(wordFrequencies, 
                key=wordFrequencies.get, reverse=True)
