# Let's clean the paragraph up a bit. We don't want to consider "It" and "it"
# as two different words, so let's make everything lowercase
...
# Let's also delete the punctuation, so "London." and "London" aren't two different words
